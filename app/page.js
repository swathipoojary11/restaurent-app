...
export default function Home()
 {
  return (
    <div className="h-full md:min-h-screen w-full overflow-x-hidden bg-gray-100">
      ...
      {/*Hero.jsx */}
      {/*booking */}
      <div className="md:mt-[0px] -mt-[50px] md:p-0 p-5 flex flex-col md:flex-row ">
        <div className="  md:ml-[100px] mr-[30px] md:mr-[1px] translate-y-1/4 md:-translate-y-1/4 bg-white text-black w-full md:w-[400px] rounded-3xl shadow-2xl px-8 py-10">
        ...
        {/*right div */}
        <div className=" md:mt-[1px] mt-[400px]  ml-[50px] flex flex-col h-[800px] md:h-[500px] w-[70%]">
          <div className="mt-[40px] ml-[50px] text-black text-5xl md:text-3xl font-semibold  md:w-full">
          ...
          <div className="  flex  flex-col md:flex-row mt-[30px] ml-[50px] gap-6">
            {/* Card 1 */}
            <div className="flex flex-col text-white text-2xl h-[600px] md:h-[300px]  md:w-1/4">
              <img
                src="https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fmenu%2F26.jpg&w=1920&q=75"
                className="rounded-2xl h-[600px] md:h-[250px] w-full object-cover"
              />
              <div className="font-bold text-6xl md:text-2xl text-amber-400  -mt-[150px] md:-mt-[70px] ml-[10px]">
                Dessert
              </div>
            ...
            {/* Card 2 */}
            <div className="hidden md:block flex flex-col text-white text-2xl h-[300px] w-1/4">
              <img
      ...
      {/*Quality card  */}
      <div className=" flex flex-col md:flex-row h-[400] w-fit  md:w-full justify-center ">
      ...
      <div className=" items-center w-full h-auto flex flex-col">
        <div className=" font-bold text-5xl md:text-lg text-yellow-800 mt-[100px] md:mt-[40px]">
          FOOD MENU
        </div>
        <div className="font-semibold text-9xl md:text-4xl text-black mt-[30px] text-center w-full md:w-auto">
          Our Specials Menu
        </div>
        <div className=" md:border-2 m md:border-gray-400 rounded-sm h-auto md:h-[70px] w-full  md:w-[600px] flex flex-col md:flex-row mt-[10px] justify-center items-center">
          <div className=" text-5xl md:text-sm mt-[100px] md:mt-[1px] h-[100px] md:h-[auto] w-full md:w-auto  md:border-0 border-2 border-b-gray-30 ml-[30px] hover:text-white hover:rounded-sm  hover:h-[40px] hover:bg-amber-900">
            MAIN DISHES
          </div>
          <div className=" text-5xl md:text-sm  mt-[30px] md:mt-[1px] h-[100px] md:h-[auto] w-full md:w-auto  md:border-0 border-2 border-b-gray-30 ml-[30px] hover:text-white hover:rounded-sm  hover:h-[40px] hover:bg-amber-900">
            MAIN DESSERT{" "}
          </div>
          <div className="text-5xl md:text-sm  mt-[30px] md:mt-[1px] h-[100px] md:h-[auto] w-full md:w-auto md:border-0 border-2 border-b-gray-30 ml-[30px] hover:text-white hover:rounded-sm  hover:h-[40px] hover:bg-amber-900">
            SEA FOOD{" "}
      ...
      <div className="  mt-[50px] flex flex-col md:flex-row h-[500px] w-full  justify-center">
      ...
      {/*menu section 2 */}
      <div className=" m-auto mt-[100px] text-white rounded-4xl h-auto  md:h-[600px] md:w-[1000px] bg-black flex flex-col md:flex-row items-center">
        <div className="h-[1400px] md:h-auto  md:w-[50%]">
          <img
            className="h-[1400px] md:h-[600px] md:w-[80%]"
        ...
        <div className=" ml-[50px] flex flex-col text-white w-[70%]">
          <div className="text-9xl md:text-5xl font-semibold">
            Are you Ready to Start
            <br /> your online Order?
          </div>
          <div className="text-gray-300 text-5xl md:text-sm mt-[150px]  md:mt-[30px]">
          ...
          <div className=" mt-[100px] md:mt-[50px] flex flex-col  md:flex-row items-center j">
            <button className=" text-5xl md:text-[15px] md:mb-[1px] mt-[1px] rounded-3xl  items-center justify-center p-[10px] flex h-[200px] md:h-[50px] w-[600px] md:w-[150px]  hover:border-2 hover:border-white hover:text-white hover:bg-black bg-yellow-50 text-black">
              App store
            </button>
            <button className=" text-5xl md:text-[15px] mb-[80] md:mb-[1px] mt-[60px] md:mt-[1px] rounded-3xl items-center justify-center p-[10px] flex h-[200px] md:h-[50px] w-[600px] md:w-[150px] md:ml-[50px] hover:text-black hover:bg-white w-[150px] bg-yellow-600 text-black">
              Play store
            </button>
          </div>
        </div>
      ...
      {/*About us page */}
      <div className=" mt-[1000px] bg-[url('https://restan-nextjs.vercel.app/assets/img/shape/5.jpg')] flex flex-col h-[700px] md:h-[300px] w-full justify-center items-center text-center text-8xl md:text-5xl font-bold text-white bg-cover bg-center">
        About Us
      </div>
      <div className=" flex flex-col items-center bg-yellow-50 h-[800px] md:h-[300px] w-full">
        <div className=" font-bold text-7xl md:text-sm text-[#806640] mt-[120px] md:mt-[50px]">
        ...
        <div className="mt-[100px] flex flex row  justify-center">
          ...
          />
          <img
            className=" h-[400px] w-[45%]  md:h-[100px] md:w-[150px]  ml-[50px] mt-auto"
      ...
      <div className="flex flex-col justify-center  ">
        <div className="  items-center flex flex-col md:flex-row h-auto md:h-[600px] w-full ">
          {/*use compoment  */}
          <img
            className="md:h-[300px] ml-[10px] h-[1000px] w-full md:w-[350px] "
          ...
          <div className="  border-1 border-gray-100 -mb-[200px] md:-ml-[50px] px-5 flex flex-col bg-white h-auto md:h-[400px] w-full md:w-[600px] bg-amber-100 shadow-2xl shadow-gray-300 ">
            <div className=" font-bold text-5xl md:text-sm text-[#806640] mt-[100px]  md:mt-[50px]">
              ABOUT US
            </div>

            <div className="font-semibold md:font-bold text-9xl md:text-5xl mt-[40px]">
              We Invite You
              <br />
              To Visit Our Restaurant
            </div>
            <div className="w-full leading-relaxed text-zinc-500 text-5xl  md:text-[11px] mt-[60px] md:mt-[20px] px-4 md:px-0">
            ...
            <button className="text-5xl md:text-[18px] md:mb-0 mb-[150px] py-0.5 hover:text-white hover:bg-black rounded-2xl  bg-[#806640] h-[100px] w-[40%] md:h-[40px] md:w-[150px] mt-[100px]  md:mt-[30px] shadow-xs shadow-amber-500">
              Discover more
            </button>
          </div>
        </div>
      ...
      <div className="  flex flex-col md:flex-row h-auto w-full md:w-[90%] mt-[300px] md:mt-[150px] m-auto">
        {/*put video */}
        <div className=" h-[1700px] md:h-[450px] md:w-[50%] bg-black">dfef</div>
        {/*Opening justify */}
      ...
      {/*location bar */}
      <div className="flex flex-col md:flex-row h-[3000px]  md:h-[250px] w-full md:w-[900px] md:m-auto  items-center">
        <div className=" mt-[200px] md:mt-[1px] ml-auto md:ml-[30px] flex flex-col border-1 bg-gray-200 border-gray-400 h-1/2 md:h-[200px] w-full md:w-[250px] items-center rounded-2xl ">
          <div className="mt-[100px] md:mt-[10px]  rounded-full bg-[url('https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Ficon%2Fphone.png&w=256&q=75')]  bg-cover bg-center h-[250px] w-[250px]  md:h-[60px] md:w-[60px]"></div>
          <div className=" mt-[10px] text-9xl md:text-2xl font-bold">Hotline</div>
          <div className="mt-[10px] text-5xl md:text-sm">+4733378901</div>
        </div>
        <div className=" mt-[50px] md:mt-[1px] ml-auto md:ml-[30px] flex flex-col border-1 bg-gray-200 border-gray-400 h-1/2 md:h-[200px] w-full md:w-[250px] items-center rounded-2xl ">
          <div className="mt-[100px] md:mt-[10px]  rounded-full bg-[url('https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Ficon%2Fphone.png&w=256&q=75')]  bg-cover bg-center h-[250px] w-[250px]  md:h-[60px] md:w-[60px]"></div>
          <div className=" mt-[10px] text-9xl md:text-2xl font-bold">Our Location</div>
          <div className="mt-[10px] text-5xl md:text-sm text-gray-600">
        ...
        <div className=" mt-[50px] md:mt-[1px] ml-auto md:ml-[30px] flex flex-col border-1 bg-gray-200 border-gray-400 h-1/2 md:h-[200px] w-full md:w-[250px] items-center rounded-2xl ">
          <div className="mt-[100px] md:mt-[10px]  rounded-full bg-[url('https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Ficon%2Fphone.png&w=256&q=75')]  bg-cover bg-center h-[250px] w-[250px]  md:h-[60px] md:w-[60px]"></div>
          <div className=" mt-[10px] text-9xl md:text-2xl font-bold">Official Email</div>
          <div className="font-semibold   mt-[10px] text-5xl md:text-sm">
            info@restan.com
          </div>
        </div>
      </div>
      {/*keep in touch part */}
      <div className="flex flex-col bg-white m-auto h-auto md:h-[500px] w-full md:w-[700px] items-center shadow-2xl shadow-gray-600 rounded-2xl">
        <div className=" font-semibold md:font-bold text-8xl md:text-sm text-[#806640] mt-[50px]">
          KEEP IN TOUCH
        </div>
        <div className="font-semibold  md:text-4xl text-9xl mt-[10px]">
  ...
  <span className="block md:inline"> Message</span>
        ...
        <div>
          <input
            type="text"
            placeholder="Name"
            className="border-1 bg-gray-100 border-gray-200 rounded-sm p-2 mt-2  md:w-[600px]"
          />
        </div>
        ...
        <button className=" hover:text-white hover:bg-black rounded-2xl bg-[#806640] h-[40px] w-[150px] mt-8 shadow-xs shadow-amber-500">
          Get in Touch
        </button>
      </div>
      {/*vidio component for about us */}
      <div className="flex flex-col  md:flex-row h-[3500px]  md:h-auto md:w-[90%] mt-[150px] md:m-auto">
       <div className="md:h-[450px] h-1/2 w-full  md:w-[60%] bg-black">dfef</div>
        
        <div className="md:-ml-[50px]  md:-mt-[60px]  h-auto  md:h-[400px] md:w-[50%]  flex flex-col  items-center">
          <div className="mt-[20px] h-[1500px]  md:h-[400px] bg-white w-full shadow-2xl border-1 border-gray-100">
            <div className=" ml-[50px] mt-[20px] text-9xl md:text-4xl font-semibold">
              Opening Hours{" "}
            </div>
            <div className="w-full leading-relaxed text-gray-600 ml-[50px] mt-[100px] md:mt-[20px] text-5xl md:text-sm">
              A relaxing and pleasant atmosphere, good jazz, dinner, and
              cocktails. The
              Patio Time Bar opens in the center..{" "}
            </div>
            ...
            <div className="flex flex-row">
              <div className="h-[60px] w-[60px]   mt-[10px] ml-[30px] rounded-full bg-[#806640]"></div>
              <div className="mt-[20px] ml-[50px] text-sm ">
                Call Anytime
                <br />
                <span className=" text-lg font-semibold"> +964733-378901</span>
      ...
      {/*menu category */}
      <div className=" mt-[1px] bg-[url('https://restan-nextjs.vercel.app/assets/img/shape/5.jpg')] flex flex-col h-[700px] md:h-[300px] w-full justify-center items-center text-center text-8xl md:text-5xl font-bold text-white bg-cover bg-center">
        Restaurant Food Menu
      </div>

      {/*menu category component */}
      <div className="flex flex-col md:m-auto h-auto w-full  j items-center">
        <div className=" font-bold text-6xl md:text-md text-[#806640] mt-[300px]  md:mt-[50px]">
          CATEGORY
        </div>
        <div className=" font-semibold  md:text-center-none text-center text-9xl text-wrap  w-[80%] md:w-full md:text-6xl mt-[100px]  md:mt-[20px]">
          Choose Your Best Food
        </div>
        <div className=" flex flex-col md:flex-row h-auto w-[90%] ">
          {/* 2 image   h-[1500px] md:h-[450px] md:w-1/4">  */}
          <div className=" m rounded-2xl flex flex-col  bg-white border-1 border-gray-200 h-[1700px] md:h-[450px] md:w-1/4">
            <img
            ...
            <div className="flex flex-row md:h-[70px] w-full  ">
              <div className="flex w-1/2 md:mt-[0px] mt-[100px] h-[200px] md:h-full items-center rounded-r-full md:rounded-r-4xl bg-gray-400">
                <div className=" ml-[60px] border-2 border-white bg-cover bg-center bg-[url('https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fteam%2F7.jpg&w=640&q=75')] md:h-[35px] md:w-[35px] w-[150px] h-[150px]  rounded-full bg-amber-500"></div>

                <div className=" border-2 border-white bg-cover -ml-[20px] bg-center bg-[url('https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fteam%2F6.jpg&w=640&q=75')] md:h-[35px] md:w-[35px] w-[150px] h-[150px] rounded-full bg-amber-500"></div>
                <div className=" -ml-[20px] border-2 border-white bg-cover bg-center bg-[url('https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fteam%2F6.jpg&w=640&q=75')] md:h-[35px] md:w-[35px] w-[150px] h-[150px] rounded-full bg-amber-500"></div>
              </div>
              <div className="flex   items-center md:ml-[60px] m-auto  text-9xl md:text-3xl font-bold text-black md:mt-[0px] mt-[100px]">
                5.0
              </div>
            </div>
            <div className=" hover:text-yellow-700 mt-[100px]  md:mt-[20px] font-semibold text-8xl md:text-2xl ml-[40px]">
              Pizza Slice
            </div>
            <div className="mt-[80px] md:mt-[20px] ml-[40px] text-4xl md:text-sm text-gray-500">
              Cheese, Ham & Pineapple
            </div>
            <button className="mt-[70px] md:mt-[20px] ml-[10px]  md:-ml-[40px]  mt- md:text-2xl text-6xl font-bold text-yellow-700">
              ORDER NOW
            </button>
          </div>
          {/*2nd block */}
